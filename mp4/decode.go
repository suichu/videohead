...
func (p *MP4) Parse() (videohead.Head, error) {
	...
	return h, errors.New("format error")
}
...
func (d *decoder) Decode(rd io.ReadSeeker) (videohead.Head, error) {
	p := &MP4{rd, moov{}}
	return p.Parse()
}

func Decode(rd io.ReadSeeker) (videohead.Head, error) {
	d := decoder{}
	return d.Decode(rd)
}
